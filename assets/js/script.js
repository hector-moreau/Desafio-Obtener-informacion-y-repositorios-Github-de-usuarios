...
function printHtml(data){
    ...
    ['name', 'login', 'public_repos', 'location', 'type'].forEach(element => {
        ...
        li.innerHTML = `<strong>${element}: </strong> ${value}`// Strong pone las letras en negrita
    ...
    $('#resultados').empty() // Limpia informacion
    $('#resultados').append(userInfo) // Asigna contenido
    $('#resultados').append(repoInfo) // Asigna contenido
